...
class studentcontroller extends Controller
{
    ...
    public function Fetch_Exam(Request $req)
    {
        ...
        ->where('Sem_ID', '1')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();

        $examfetch2 = DB::table('modulars')
        ->where('Sem_ID', '2')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();


        $examfetch3 = DB::table('modulars')
        ->where('Sem_ID', '3')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();


        $examfetch4 = DB::table('modulars')
        ->where('Sem_ID', '4')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();


        $examfetch5 = DB::table('modulars')
        ->where('Sem_ID', '5')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();


        $examfetch6 = DB::table('modulars')
        ->where('Sem_ID', '6')->where('Std_ID' ,session('user'))
        ->orderBy('id','desc')->get();
